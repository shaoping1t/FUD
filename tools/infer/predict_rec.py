...
from fud.utils.utility import get_image_file_list, check_and_read
...
class TextRecognizer(object):
    ...
    def resize_norm_img_fud(self, img, image_shape):
    ...
    def __call__(self, img_list):
        ...
        for beg_img_no in range(0, img_num, batch_num):
            ...
            for ino in range(beg_img_no, end_img_no):
                ...
                elif self.rec_algorithm == "FUD":
                    norm_img = self.resize_norm_img_fud(img_list[indices[ino]],
