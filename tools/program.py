...
from fud.utils.stats import TrainingStats
from fud.utils.save_load import save_model
from fud.utils.utility import print_dict, AverageMeter
from fud.utils.logging import get_logger
from fud.utils.loggers import VDLLogger, WandbLogger, Loggers
from fud.utils import profiler
from fud.data import build_dataloader
...
def train(config,
    ...
    extra_input_models = [
        "SRN", "NRTR", "SAR", "SEED", "FUD", "SPIN", "VisionLAN",
...
def preprocess(is_train=False):
    ...
    assert alg in [
        ...
        'FUD', 'ViTSTR', 'ABINet', 'DB++', 'TableMaster', 'SPIN', 'VisionLAN',
